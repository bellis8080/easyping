...
export default async function AgentInboxPage() {
  ...
  // Story 5.2: Include SLA tracking fields for timer display
  ...
  const transformedPings =
    pings?.map((ping) => ({
      ...
      // SLA tracking fields (Story 5.2)
      sla_policy_id: ping.sla_policy_id,
      sla_first_response_due: ping.sla_first_response_due,
      sla_resolution_due: ping.sla_resolution_due,
      first_response_at: ping.first_response_at,
      resolved_at: ping.resolved_at,
      sla_paused_at: ping.sla_paused_at,
      sla_paused_duration_minutes: ping.sla_paused_duration_minutes ?? 0,
